/**
 * @file mlkit.ts
 * @description The hooks that require `@pixelkit/mlkit`, behind their own entry point.
 *
 * Expo autolinking scans `node_modules` for `expo-module.config.json`; it does not care whether any
 * JavaScript imports the module. So merely having `@pixelkit/mlkit` installed puts 19 ML Kit
