...
* **[HiLight LED Array](./research/HILIGHT_LED_ARRAY.md)**: Measured lights-service facts (eight `LIGHT_TYPE_APPLICATION` lights), the `CONTROL_DEVICE_LIGHTS` permission gate, and on-screen simulation architecture.
